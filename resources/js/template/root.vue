<template>
  <vs-row w="12">
    ...
    <vs-col w="9">
      ...
      <vs-row w="12">
        <vs-col style="margin-left: 20px; margin-bottom: 20px" :key="index" v-for="col,index in 20" w="2">
          <vs-card type="2">
            <template #title>
        ...
        <vs-col>
          <vs-card type="2" class="add-card-button">
            <template #img>
              <div style="width: 350px; height: 350px; font-size: 10em">
